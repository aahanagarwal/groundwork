...
const STATUS_STYLE: Record<CapabilityStatus, { label: string; className: string }> = {
  answering: { label: "Answering now", className: "border-survey bg-survey text-paper" },
  ...
  return (
    <section className="card-flat p-5">
      ...
      <p className="mb-4 max-w-[66ch] text-[15px] leading-snug">
        ...
        can&rsquo;t answer yet, it says so - a capability list that hides its own
        gaps is a brochure.
      </p>
