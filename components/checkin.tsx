    ...
    <section className="card border-l-[5px] border-signal p-0">
        ...
        <p className="mt-2 max-w-[58ch] text-[15px] leading-snug">
          {gap > 0 ? (
            <>
              ...
              can&rsquo;t account for. No permit, forecast or feed we hold
              covers them. You&rsquo;re the only one who knows what that was —
              tell us and we&rsquo;ll stop counting it against the street.
            </>
          ) : (
            <>
              Anything the feeds wouldn&rsquo;t catch? Staffing, equipment, a
              late open, a change on the menu. It gets recorded against the day
              and shown next to the numbers.
            </>
          )}
        </p>
      </header>
      ...
      <div className="px-5 py-4">
        ...
        <p className="mt-3 max-w-[62ch] font-mono text-[11px] leading-relaxed text-stone">
          What you write here is shown next to the unexplained figure — it is
          not fed into the model. What you tell us is testimony, not a
          measurement, and turning it into a coefficient would invent precision
          nobody earned.
        </p>
      </div>
            ...
            {existing.slice(0, 4).map((entry) => (
              <li
                ...
                <span className="min-w-0">
                  ...
                  {entry.tags.map(checkinTagLabel).join(", ")}
