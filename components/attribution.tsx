...
export function AttributionWaterfall({
  ...
  const extent = Math.max(
    ...rows.map((r) =>
      Math.max(Math.abs(r.low), Math.abs(r.high), Math.abs(r.points)),
    ),
    ...
    <section className="card p-0">
      ...
      <div className="px-5 py-5">
                    ...
                    {row.driver ? (
                      ...
                      <Cited
                        ...
                        detail={{
                          ...
                          saturatedWindow:
                            attribution.diagnostics.saturatedWindow,
                        }}
                        provenance={{
        ...
        <div className="mt-5 border-t border-rule pt-4 text-[15px] leading-snug">
          <span className="label">Reach, or price?</span> Basket size moved{" "}
          <Cited
