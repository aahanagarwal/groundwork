...
export function ActionCenter({ actions }: { actions: ProposedActionRecord[] }) {
  if (actions.length === 0) {
    return (
      <section className="card-flat p-5 text-stone">
        <h2 className="font-display text-[24px] font-bold uppercase tracking-tight text-ink mb-1.5">
          Action center
        </h2>
        <p className="text-[15px]">No actions proposed for this window.</p>
      </section>
    );
  }
        ...
        <div className="min-w-0">
          <div className="label">
            ...
            {action.requiresApproval ? (
              ...
              <span className="ml-2 text-stone">alert - no approval needed</span>
            )}
          </div>
              ...
              <div>
                ...
                <div className="font-mono text-[17px] tabular">
                  <Cited
                    ...
                    detail={{ costUsd: action.costUsd, expectedValueUsd: action.expectedValueUsd }}
                    provenance={
            ...
            {confirming ? (
              <div className="border-[1.5px] border-ink bg-limestone p-4">
                <p className="text-[15px] leading-snug">
                  This will mark the draft approved in Groundwork&rsquo;s database.{" "}
                  <strong>
                    Nothing is sent anywhere - no ad account is connected in this
                    build.
                  </strong>
                </p>
