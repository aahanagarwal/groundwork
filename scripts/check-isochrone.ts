...
const SITES: Array<{ slug: string; label: string; at: LatLng }> = [
  {
    slug: "jos-coffee",
    label: "Jo's Coffee, 1300 S Congress",
    at: { lat: 30.2515, lng: -97.7494 },
  },
  {
    slug: "radio-coffee",
    label: "Radio Coffee & Beer, 4204 Menchaca",
    at: { lat: 30.2265, lng: -97.7935 },
  },
  {
    slug: "franklin-barbecue",
    label: "Franklin Barbecue, 900 E 11th",
    at: { lat: 30.2701, lng: -97.7313 },
  },
];
...
async function main() {
  for (const site of SITES) {
    ...
    console.log(
      `probes ${iso.probesTested}   paid driving calcs ${iso.paidDrivingCalcs}`,
    );
